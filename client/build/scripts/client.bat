...
set CLASSPATH=%APP_HOME%\lib\client.jar;%APP_HOME%\lib\server.jar;%APP_HOME%\lib\general.jar;%APP_HOME%\lib\gson-2.10.1.jar;%APP_HOME%\lib\xstream-1.4.15.jar;%APP_HOME%\lib\opencsv-5.7.1.jar;%APP_HOME%\lib\xmlpull-1.1.3.1.jar;%APP_HOME%\lib\xpp3_min-1.1.4c.jar;%APP_HOME%\lib\commons-text-1.10.0.jar;%APP_HOME%\lib\commons-lang3-3.12.0.jar;%APP_HOME%\lib\commons-beanutils-1.9.4.jar;%APP_HOME%\lib\commons-collections4-4.4.jar;%APP_HOME%\lib\commons-logging-1.2.jar;%APP_HOME%\lib\commons-collections-3.2.2.jar
